 ...
 *
 *  Name: Nadiia Geras Student ID: 121297204 Date: April 11, 2025
 *
 *  Link:
 ********************************************************************************/
    ...
    <>
      ...
      <Row>
        <Col>
          <Image
            ...
            fluid
            rounded
            alt="Image of the front of the Metropolitan Museum of Art"
          />
        </Col>
      </Row>
      <br />
      ...
      <Row>
        <Col lg={6}>
          ...
          the Museum Mile on the eastern edge of Central Park on
          Manhattan&apos;s Upper East Side, is by area one of the world&apos;s
          largest art museums. A much smaller second location, The Cloisters at
          Fort Tryon Park in Upper Manhattan, contains an extensive collection
          of art, architecture, and artifacts from medieval Europe. The
          Metropolitan Museum of Art was founded in 1870 with its mission to
